...
INSERT INTO conundrums (text, author, verified, stars, date) VALUES
    ('Ühel mehel oli lagi nii madal, et ta sai ainult lesta süüa!', 'Kermo Kahveltõstuk', 1, 1, '2025-07-29 12:23:13'),
    ('Kui hull kukub aknast alla siis pole hullu!', 'Juhan Juustuburger', 1, 0, '2025-07-29 12:23:13'),
    ('Mees seisab mööda teed.', 'Juhan Juustuburger', 1, 0, '2025-07-29 12:23:13'),
    ...
    ('Kala sureb lahtise suuga!', 'Juhan Juustuburger', 1, 0, '2025-07-29 12:23:13'),
    ('Meil on Kuusalust Gyproki vaja! Varustaja jõuab tagasi kuue aluse Gyprokiga!', 'Juhan Juustuburger', 1, 0, '2025-07-29 12:23:13'),
    ('Saatan käis maal ja ta sõitis Cadillaciga!', 'Juhan Juustuburger', 1, 0, '2025-07-29 12:23:13'),
    ...
    ('Näljane mõtleb ikka leivast!', 'Artur Atsetoon', 1, 0, '2025-07-29 12:23:13'),
    ('Magavale hiirele kass suhu ei jookse', 'Andreas Akudrell', 1, 0, '2025-07-29 12:23:13'),
    ('Miks läks kann üle tee? Ta oli teekann!', 'Mihkel Majameister', 1, 0, '2025-07-29 12:23:13'),
    ('Nüüd ma olen küll endale karuteene teinud!', 'Juhan Juustuburger', 1, 0, '2025-07-30 13:18:16'),
